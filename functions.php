...
//** Add ScrollMagic CDN !!! Create Custom JS File Once Tested !!!

function sl_scroll_js() {
	
	wp_enqueue_script( 'sl-scroll-min-js', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/ScrollMagic.min.js', array(), true ); 

	wp_enqueue_script( 'sl-scrolljquery-min-js', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/debug.addIndicators.min.js', array(), true ); }

add_action( 'wp_enqueue_scripts', 'sl_scroll_js' );

//** Add Macy Masonry

function sl_masonry_js() {
	
	wp_enqueue_script( 'sl-masonry-js', get_template_directory_uri() . '/js/macy.js', array(), true ); }

add_action( 'wp_enqueue_scripts', 'sl_masonry_js' );

//** Add Fancybox Masonry

function sl_fancybox() {
	
	wp_enqueue_script( 'sl-fancybox-js', get_template_directory_uri() . '/fancybox/jquery.fancybox.min.js', array(), true ); }

	wp_enqueue_style( 'sl-fancybox-css', get_template_directory_uri() . '/fancybox/jquery.fancybox.min.css' );

add_action( 'wp_enqueue_scripts', 'sl_fancybox' );
...
$page_footer = array(
		'page_title' 	=> 'KHS Footer Settings',
		'menu_title'	=> 'Footer Settings',
		'menu_slug' 	=> 'khs-footer-settings',
		'capability'	=> 'edit_posts',
		'post_id' 		=> 'khs_footer',
		'redirect'		=> false
		);
acf_add_options_page($page_footer);

$page_header = array(
		'page_title' 	=> 'KHS Header Settings',
		'menu_title'	=> 'Header Settings',
		'menu_slug' 	=> 'khs-header-settings',
		'capability'	=> 'edit_posts',
		'post_id' 		=> 'khs_header',
		'redirect'		=> false
		);
acf_add_options_page($page_header);

$page_header = array(
		'page_title' 	=> 'KHS Find A Safari',
		'menu_title'	=> 'Find A Safari',
		'menu_slug' 	=> 'khs-find',
		'capability'	=> 'edit_posts',
		'post_id' 		=> 'khs_find',
		'redirect'		=> false
